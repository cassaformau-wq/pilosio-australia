    ...
    <div>
      ...
      <div className="bg-[#023569] text-white py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-white text-xs font-bold uppercase tracking-widest mb-2">Suspended Structures</div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="flex items-center gap-3 mb-10">
          ...
          <h2 className="text-[#023569] text-2xl font-black uppercase tracking-wide">Our Suspended Systems</h2>
        </div>
          ...
          {systems.map((s) => (
            ...
            >
              ...
              <div className="p-5 flex flex-col flex-1">
                <div className="text-xs text-[#023569] font-bold uppercase tracking-wider mb-1">{s.code}</div>
                <h3 className="text-[#023569] font-black uppercase tracking-wide text-sm mb-2">{s.name}</h3>
